        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/selvaganesh19/EV-Battery-Management-System-using-Deep-Learning" // Update with your repo
              demoLink="https://colab.research.google.com/drive/1RYs28Af6R3aTXynstC9fEWn8zzOkOdc1?usp=sharing" // Add real demo link if available
            />
          </Col>
